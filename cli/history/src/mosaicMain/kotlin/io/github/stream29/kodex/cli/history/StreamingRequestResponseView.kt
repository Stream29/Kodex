 ...
 */
@Composable
public fun KodexAgentStateValue.RequestResponse.renderStreamingTail(
    onContentChange: () -> Unit = {},
) {
    when (this) {
        KodexAgentStateValue.RequestResponse.Started -> StreamingStatusTail("Starting response…")
        is KodexAgentStateValue.RequestResponse.Message -> StreamingMessageTail(events, onContentChange)
        is KodexAgentStateValue.RequestResponse.AgentMessage -> StreamingAgentMessageTail(events, onContentChange)
        is KodexAgentStateValue.RequestResponse.Reasoning -> StreamingReasoningTail(events, onContentChange)
        is KodexAgentStateValue.RequestResponse.ToolCall -> StreamingToolCallTail(events, onContentChange)
        is KodexAgentStateValue.RequestResponse.Unknown -> StreamingUnknownTail(events, onContentChange)
    }
}
