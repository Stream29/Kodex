...
internal class LocalCodexLiteLoginAttempt private constructor(
    ...
    private val onFinished: suspend (LocalCodexLiteLoginAttempt) -> Unit,
    ...
    internal companion object {
        suspend fun start(
            ...
            onFinished: suspend (LocalCodexLiteLoginAttempt) -> Unit,
            callbackPorts: List<Int> = DefaultCallbackPorts,
        ): LocalCodexLiteLoginAttempt {
...
private fun handleLoginCallback(
    ...
    state != expectedState -> CallbackResponse(
        ...
        body = "The sign-in response could not be verified. Return to Codex Lite and try again.",
    )
    ...
    !error.isNullOrBlank() -> {
        ...
        CallbackResponse(
            status = HttpStatusCode.BadRequest,
            body = "Sign-in was not completed. Return to Codex Lite to try again.",
        )
    }
    ...
    authorizationCode.isNullOrBlank() -> {
        ...
        CallbackResponse(
            status = HttpStatusCode.BadRequest,
            body = "The sign-in response was incomplete. Return to Codex Lite and try again.",
        )
    }
        ...
        CallbackResponse(
            ...
            body = "Sign-in complete. You can return to Codex Lite.",
        )
    }
}
