 ...
 */
public fun CodexAgentSettings.toHookSessionContext(sessionId: String): HookSessionContext =
    HookSessionContext(
        sessionId = sessionId,
        cwd = cwd,
        model = model.value,
 ...
 * @param sessionId Identity of the Agent storage that owns [this].
 */
public fun CodexAgentSettings.toHookTurnContext(sessionId: String): HookTurnContext =
    HookTurnContext(
