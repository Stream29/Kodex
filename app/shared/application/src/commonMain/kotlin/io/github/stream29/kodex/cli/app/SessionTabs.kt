...
public sealed interface SessionTabTarget {
...
public data class SessionTabViewState(
    public val target: SessionTabTarget,
    public val selected: Boolean,
    public val rootSession: RootSessionEntry? = null,
    public val newSessionName: String? = null,
)
