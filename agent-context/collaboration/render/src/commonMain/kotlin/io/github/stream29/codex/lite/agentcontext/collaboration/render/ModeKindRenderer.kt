 ...
 *
 * @return The Plan mode developer block. `null` for [ModeKind.Default], whose
 * default Rust session configuration has no collaboration-mode block.
 */
public fun ModeKind.render(): String? =
    when (this) {
        ModeKind.Default -> null
