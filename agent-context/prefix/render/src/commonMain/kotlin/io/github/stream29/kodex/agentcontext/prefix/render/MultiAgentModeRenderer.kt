...
/** Renders the Multi-agent policy implied by the current reasoning effort. */
public fun ReasoningEffort.renderMultiAgentMode(): String =
    "$MultiAgentModeOpeningTag${multiAgentModeBody()}$MultiAgentModeClosingTag"

private fun ReasoningEffort.multiAgentModeBody(): String =
    when (this) {
        ReasoningEffort.Ultra -> ProactiveInstructions
        else -> ExplicitRequestOnlyInstructions
    }
...
private const val ExplicitRequestOnlyInstructions: String =
...
private const val ProactiveInstructions: String =
