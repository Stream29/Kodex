...
import io.github.stream29.codex.lite.utils.processclient.cinterop.codexlite_spawn_process
import io.github.stream29.codex.lite.utils.processclient.cinterop.codexlite_process_write
                    ...
                    environment.entries.map { (name, value) -> "$name=$value" }
                        .withPosixStrings { environmentValues, environmentCount ->
                            memScoped {
                                ...
                                val result = codexlite_spawn_process(
                                    pid = pid.ptr,
