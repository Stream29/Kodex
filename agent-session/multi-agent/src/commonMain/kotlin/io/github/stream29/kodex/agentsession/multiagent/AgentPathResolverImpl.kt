...
public class AgentPathResolverImpl(
    ...
    override suspend fun resolveOrNull(path: String): KodexAgentSession? {
...
private suspend fun KodexAgentSession.resolveDescendantOrNull(
...
private suspend fun KodexAgentSession.agentNameOrNull(): String? {
