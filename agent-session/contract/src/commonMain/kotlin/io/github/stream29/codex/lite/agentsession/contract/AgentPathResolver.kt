...
public suspend fun AgentPathResolver.rootSession(): CodexAgentSession =
...
public suspend fun AgentPathResolver.pathOf(session: CodexAgentSession): String =
...
public suspend fun AgentPathResolver.parentOf(session: CodexAgentSession): CodexAgentSession? {
...
public suspend fun AgentPathResolver.listChild(session: CodexAgentSession): List<CodexAgentSession> =
